  ...
  Signal f, Signal g )    
{
  ...
  And ( SD("1c"), (x, z), andA1);
  And ( SD("2c"), (noty, notz), andB1);
 
  And ( SD("3c"), (notw, y), andD1);
  And ( SD("3c"), (x, z), andD2);
  And ( SD("3c"), (w, noty), andD3);
  
  Or (SD ("1d"), (andP1, andP2, andP3, andP4), Present);
  Or (SD ("2d"), (y, w, andA1), a);
  Or (SD ("3d"), (notx, andB1), b);
  Or (SD ("4d"), (w, x, noty), c);
  
  Or (SD ("1d"), (andD1, andD2, andD3), d);
  Or (SD ("2d"), (w, y), e);
  Or (SD ("3d"), (w, x), f);
  Or (SD ("4d"), (x, notz), g);
